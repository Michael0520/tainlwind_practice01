...
<main class="dark:bg-gray-800 bg-white relative overflow-hidden h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 flex relative z-30 items-center overflow-hidden">
        <div class="container mx-auto px-6 flex relative py-16">
            <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                ...
                <p class="text-sm sm:text-base text-gray-700 dark:text-white">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex ab expedita exercitationem ducimus, laudantium sit.
                </p>
                <div class="flex mt-8">
            ...
            <div class="hidden sm:block sm:w-1/3 lg:w-3/5 relative">
                <img src="https://i.pinimg.com/564x/48/5c/66/485c66f96bbea6960c816bbfd91e4f8c.jpg" class="max-w-xs md:max-w-sm m-auto"/>
            </div>
        </div>
    </div>
</main>
